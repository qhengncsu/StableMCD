...
// proj_depth
Rcpp::NumericVector proj_depth(const arma::mat& X, const arma::mat& data, int style, int multiplier);
RcppExport SEXP _StableMCD_proj_depth(SEXP XSEXP, SEXP dataSEXP, SEXP styleSEXP, SEXP multiplierSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(proj_depth(X, data, style, multiplier));
...
static const R_CallMethodDef CallEntries[] = {
    {"_StableMCD_proj_depth", (DL_FUNC) &_StableMCD_proj_depth, 4},
